...
print('1Round Player 1 카드정보 >>>>  ')
player1.get_card_info()
print('>>>>>>>>><<<<<<<<<')

print('1Round Player 2 카드정보 >>>>  ')
player2.get_card_info()
print('>>>>>>>>><<<<<<<<<')

print('1Round Player 3 카드정보 >>>>  ')
...
print('2Round Player 1 카드정보 >>>>  ')
player1.get_card_info()
print('>>>>>>>>><<<<<<<<<')

print('2Round Player 2 카드정보 >>>>  ')
player2.get_card_info()
print('>>>>>>>>><<<<<<<<<')

print('2Round Player 3 카드정보 >>>>  ')
player3.get_card_info()
print('>>>>>>>>><<<<<<<<<')
...
print('3Round Player 1 카드정보 >>>>  ')
player1.get_card_info()
print('>>>>>>>>><<<<<<<<<')

print('3Round Player 2 카드정보 >>>>  ')
player2.get_card_info()
print('>>>>>>>>><<<<<<<<<')

print('3Round Player 3 카드정보 >>>>  ')
player3.get_card_info()
print('>>>>>>>>><<<<<<<<<')